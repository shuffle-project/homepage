...
export const EASY_WEB_CHECK: Project = {
	...
	joinEvaluation: {
		...
		introduction:
			'Die Webseite befindet sich aktuell noch in der Entwicklung. Wir freuen uns über Feedback und Rückmeldungen zu den Inhalten oder möglichen technischen Barrieren über die folgende Email-Adresse.',
