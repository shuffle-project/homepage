...
<div class="page-content headings-with-padding">
	...
	<p>
		Die Hochschule der Medien Stuttgart ist eine Körperschaft des öffentlichen Rechts. Sie wird
		durch den Rektor Prof. Dr. Alexander W. Roos gesetzlich vertreten.
	</p>

	<p>
		<b>
			<abbr title="Umsatzsteuer-Identifikationsnummer">USt.-ID-Nr.</abbr>
		</b>
		DE 224 427 890
	</p>

	<h3>Für die Website verantwortlich:</h3>

	<p>
		Prof. Dr. Gottfried Zimmermann<br />Hochschule der Medien<br />Nobelstr. 10<br />70569 Stuttgart
	</p>
	...
	<p>
		Ministerium für Wissenschaft, Forschung und Kunst Baden-Württemberg<br />Königstraße 46<br
		/>70173 Stuttgart
	</p>
	...
	<p>
		Der Autor (Anbieter dieser Website) bzw. die einzelnen Verfasser übernimmt keinerlei Gewähr für
		die Aktualität, Korrektheit, Vollständigkeit oder Qualität der bereitgestellten Informationen.
		Haftungsansprüche gegen den Autor oder Verfasser, welche sich auf Schäden materieller oder
		ideeller Art beziehen, die durch die Nutzung oder Nichtnutzung der dargebotenen Informationen
		bzw. durch die Nutzung fehlerhafter und unvollständiger Informationen verursacht wurden, sind
		grundsätzlich ausgeschlossen, sofern seitens des Autors oder der Verfasser kein nachweislich
		vorsätzliches oder grob fahrlässiges Verschulden vorliegt. Alle Angebote sind freibleibend und
		unverbindlich. Der Autor und die Verfasser behalten es sich ausdrücklich vor, Teile der Seiten
	...
	<p>
		...
		des eigenen Internetangebotes gesetzten Links und Verweise sowie für Fremdeinträge in vom Autor
	...
	<p>
		Der Autor bzw. die Verfasser sind bestrebt, in allen Publikationen die Urheberrechte der
	...
	<p>
		...
		und den Besitzrechten der jeweiligen eingetragenen Eigentümer. Allein aufgrund der bloßen
		Nennung ist nicht der Schluss zu ziehen, dass Markenzeichen nicht durch Rechte Dritter geschützt
		sind! Das Copyright für veröffentlichte, vom Autor oder Verfasser selbst erstellte Objekte
		bleibt allein beim Autor/den Verfassern der Seiten bzw. Texte und Inhalte. Eine Vervielfältigung
		oder Verwendung solcher Grafiken, Tondokumente, Videosequenzen und Texte in anderen
		elektronischen oder gedruckten Publikationen ist ohne ausdrückliche Zustimmung des Autors/der
		Verfasser nicht gestattet.
	</p>
