...
<div class="articles">
	<ArticlePreview
		...
		time="23.10.2023"
		link="shuffle-projekttreffen-in-heidelberg"
	>
		Im Oktober stand unser nächstes gemeinsames SHUFFLE-Projekttreffen an, das wir dieses Mal in
		Heidelberg durchgeführt haben. Zwei Tage konnten wir uns beim Herbsttreffen über den aktuellen
		Stand der verschiedenen Arbeitspakete informieren, Pläne für die noch vor uns liegende Zeit im
		Projekt machen und in einigen Workshops an konkreten Aufgabestellungen arbeiten. Der erste […]
	</ArticlePreview>

	<ArticlePreview
		title="Konferenzbeiträge bei der GeNeMe 2023"
		time="16.10.2023"
		link="konferenzbeitraege-bei-der-geneme-2023"
	>
		Am 14. und 15. September hatten wir die Möglichkeit, unseren aktuellen Stand des
		Reifegradmodells aus AP01 auf der GeNeMe 2023 in Dresden vorzustellen. Die GeNeMe “ Gemeinschaft
		in Neuen Medien ” ermöglicht einen transdiziplinären Austausch insbesondere zu online
		Communities. Das diesjährige Motto der Konferenz war “Inklusiv Digital – Gemeinschaft offen
		gestalten” und ermöglichte […]
	</ArticlePreview>

	<ArticlePreview
		title="Zwei Tage lernen, grübeln und vernetzen auf der Summer School"
		time="13.10.2023"
		link="zwei-tage-lernen-gruebeln-und-vernetzen-auf-der-summer-school"
	>
		Bereits seit Ende 2022 laufen im Begleitprogramm zur Projektförderung der Stiftung Innovation in
		der Hochschullehre (StIL) hochwertige Weiterbildungen für Projektleitungen und -mitarbeitende.
		Auch einige unserer Teammitglieder durften sich über die begehrten Teilnahmeplätze freuen. Am 7.
		Und 8. September […]
	</ArticlePreview>
	...
	<ArticlePreview
		...
		time="07.08.2023"
		link="kennst-du-eigentlich-gabriel"
	>
		SHUFFLE und Gabriel in Marburg. Vergangene Woche war ein Teil des AP06-Teams auf dem 37. VBS
		Kongress in Marburg (Verband für Blinden- und Sehbehindertenpädagogik). In interessanten
		Vorträgen, Workshops, Hilfsmittelausstellungen und Selbsterfahrungstrainings konnten Ann-Katrin,
		Niklas, Frank, Markus und Patricia in die aktuellen Diskurse der […]
	</ArticlePreview>

	<ArticlePreview title="CHI2023" time="07.06.2023" link="chi2023">
		SHUFFLE auf der CHI 2023. Vier unserer SHUFFLElistas (Nadine, Verena, Kathy, Kobi) waren in
		Hamburg auf einer der größten und wichtigsten internationalen Konferenzen in der Informatik: Der
		CHI <span lang="en">(“ACM CHI Conference on Human Factors in Computing Systems”)</span>. Die
		weltweite Forschung im Bereich Mensch-Maschine […]
	</ArticlePreview>

	<ArticlePreview
		title="Accessibility Day in Stuttgart"
		time="22.05.2023"
		link="accessibility-day-in-stuttgart"
	>
		Am Freitag, 28.04.2023, fand der sechste Accessibility Day des Kompetenzzentrums für Digitale
		Barrierefreiheit an der Hochschule der Medien in Stuttgart statt. Expertinnen und Experten
		hielten Vorträge über digitale Barrierefreiheit mit Fokus auf Smart Homes und selbstbestimmtes
		Leben. Die Veranstaltung bot Interessierten einen Einblick in den aktuellen Stand und […]
	</ArticlePreview>

	<ArticlePreview
		title="Frühlingstreffen in Bielefeld"
		time="17.05.2023"
		link="fruehlingstreffen-in-bielefeld"
	>
		Ende Februar haben wir uns für zwei Tage zu einem intensiven und aufschlussreichen Team-Meeting
		in Bielefeld an der Universität getroffen. Viele Team-Mitglieder hatten interessante Sessions
		vorbereitet und wir konnten uns über verschiedenste Themen austauschen und diskutieren. Den
		ersten Vormittag haben wir damit verbracht, sowohl unsere […]
	</ArticlePreview>

	<ArticlePreview
		title="Die Zukunft barrierefrei! – SHUFFLE mit zwei Beiträgen beim University Future Festival 2023"
		time="08.05.2023"
		link="die-zukunft-barrierefrei-shuffle-mit-zwei-beitraegen-beim-university-future-festival-2023"
	>
		Auch beim diesjährigen University Future Festival war das SHUFFLE-Team mit diesmal zwei
		Lightning-Talks vertreten. In der Session Barrieren wahrnehmen und abbauen stellten zuerst
		Ann-Katrin Böhm aus Heidelberg und Christin Stormer aus Bielefeld für das AP01 die Entwicklung
		eines Reifegradmodells vor, das […]
	</ArticlePreview>

	<ArticlePreview title="SHUFFLE unterwegs" time="03.12.2022" link="shuffle-unterwegs">
		Eine spannende und ereignisreiche Woche geht vorbei. Neun SHUFFLE-Mitgliedern haben sich auf den
		Weg nach Tschechien gemacht, um mit neuen Ideen und Anregungen im Gepäck unser Projekt
		voranzubringen. Die Reise führte uns zuerst an das Teiresias Centre der Masaryk Universität in
