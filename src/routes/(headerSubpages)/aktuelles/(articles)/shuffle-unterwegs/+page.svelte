...
<svelte:head>
	<title>SHUFFLE unterwegs - SHUFFLE</title>
</svelte:head>

<ArticleHeader title="SHUFFLE unterwegs" authorName="Jule Günter" date="03.12.2022" />
...
<p>
	Wir danken allen Kolleg*innen aus Brünn und Ostrava für die vielfältigen und interessanten
	Eindrücke, die wir gewinnen durften! Unser Projekt SHUFFLE wird sicherlich sehr davon profitieren.
</p>
